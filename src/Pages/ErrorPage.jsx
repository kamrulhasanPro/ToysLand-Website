...
const ErrorPage = ({issue}) => {
    const navigate = useNavigate()
      const error = useRouteError();
  return (
    <>
      <main className={`grid grow ${issue ? 'min-h-screen' : 'max-h-screen'} place-items-center px-6 lg:px-8`}>
        <div className="text-center">
          ...
          <p className="mt-6 text-lg font-medium text-pretty text-gray-400 sm:text-xl/8">
            Sorry, something is wrong. You’re looking for.
          </p>
